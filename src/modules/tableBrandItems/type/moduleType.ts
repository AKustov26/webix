...
export interface ICustomFilterProps {
    webixElName: string, // наименование webix элемента
    filterColumnId: string, // уникальное наименование фильтра
}
export interface ICustomFilterSearchProps extends ICustomFilterProps {
    filterColumnList: string[] // список столбцов по которым осуществлется фильтрация
}